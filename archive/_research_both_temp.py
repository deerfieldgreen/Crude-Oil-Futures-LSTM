...
data_df.drop(['VMD_0', 'VMD_1', 'VMD_2', 'VMD_3'], axis=1, inplace=True)

year_vec = np.array(sorted(list(set(data_df['year']))))
price_vec = data_df["close_D1"].values


save_vmd_feat_dict = True
vmd_alpha = 2000
vmd_lookback = 120
vmd_k = 4
...
# cols = ['datetime','VMD_0','VMD_1','VMD_2','VMD_3']
# data_df[cols].tail(20)
# 
#                 datetime  VMD_0  VMD_1  VMD_2  VMD_3
# 2729 2023-10-10 02:00:00 86.106 -3.381  0.993  0.016
# 2730 2023-10-11 02:00:00 85.371  1.340 -0.498 -0.030
# 2731 2023-10-12 02:00:00 84.929  1.317 -1.084 -0.049
# 2732 2023-10-13 02:00:00 84.586  0.972  0.421  0.059
# 2733 2023-10-16 02:00:00 85.953 -3.309  1.326  0.044
# 2734 2023-10-17 02:00:00 86.045 -2.822 -0.480 -0.113
# 2735 2023-10-18 02:00:00 85.093  0.444 -0.873  0.188
# 2736 2023-10-19 02:00:00 85.359  0.066  0.580 -0.102
# 2737 2023-10-20 02:00:00 85.821  0.418  0.957  0.071
# 2738 2023-10-23 02:00:00 86.622  0.071 -0.545 -0.029
# 2739 2023-10-24 02:00:00 86.168 -0.412 -0.976 -0.062
# 2740 2023-10-25 02:00:00 86.266 -0.109 -0.937  0.042
# 2741 2023-10-26 02:00:00 86.161 -0.195  0.889  0.009
# 2742 2023-10-27 02:00:00 85.977 -0.578 -0.301 -0.150
# 2743 2023-10-30 02:00:00 85.912 -0.549 -0.510  0.219
# 2744 2023-10-31 02:00:00 85.683 -0.974 -0.742 -0.227
# 2745 2023-11-01 02:00:00 85.392 -1.555  0.155  0.104
# 2746 2023-11-02 02:00:00 85.133 -2.103  0.397 -0.033
# 2747 2023-11-03 02:00:00 85.035 -2.273  0.690 -0.060
# 2748 2023-11-06 02:00:00 84.828 -2.598 -0.470  0.019
